...
export default function WebSocketDemo() {
	...
	return (
		<div className="container mx-auto p-6">
			...
			<div className="flex flex-row flex-wrap gap-8 pt-16">
				<Tool
				...
				/>
				<Tool
					title="get_sentry_tool"
					description="Gets error information from Sentry."
					active={isActive(messages, "GET_SENTRY_TOOL")}
					messages={getMessages(messages, ["GET_SENTRY_TOOL"])}
				/>
				<Tool
					title="get_umami_tool"
					description="Gets significant user flows from Umami."
					active={isActive(messages, "GET_UMAMI_TOOL")}
					messages={getMessages(messages, ["GET_UMAMI_TOOL"])}
				/>
				<Tool
					title="run_test_tool"
